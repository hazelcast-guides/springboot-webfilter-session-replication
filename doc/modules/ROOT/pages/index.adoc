...
Spring Boot is really well integrated with Hazelcast. You can check the other guide xref:caching-springboot:ROOT:index.adoc[Caching with Spring Boot and Hazelcast]. You can also set up your Hazelcast in the client-server topology instead of using embedded Hazelcast.
